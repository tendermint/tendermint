...
import (
	...
	github_com_tendermint_tendermint_libs_bits "github.com/tendermint/tendermint/libs/bits"
	io "io"
	math "math"
	math_bits "math/bits"
	time "time"
...
type Commit struct {
	...
	bitArray *github_com_tendermint_tendermint_libs_bits.BitArray `protobuf:"bytes,6,opt,name=bit_array,json=bitArray,proto3,customtype=github.com/tendermint/tendermint/libs/bits.BitArray" json:"bit_array,omitempty"`
}
...
var fileDescriptor_2c0f90c600ad7e2e = []byte{
	...
	,
}
...
func (m *Commit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.bitArray != nil {
		{
			size := m.bitArray.Size()
			i -= size
			if _, err := m.bitArray.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintTypes(dAtA, i, uint64(size))
		}
...
func (m *Commit) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			var v github_com_tendermint_tendermint_libs_bits.BitArray
			m.bitArray = &v
