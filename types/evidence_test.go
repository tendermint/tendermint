...
func TestMaxEvidenceBytes(t *testing.T) {
	...
	ev := &DuplicateVoteEvidence{
		...
		VoteA:  makeVote(t, val, chainID, math.MaxInt32, math.MaxInt64, math.MaxInt32, math.MaxInt32, blockID),
		VoteB:  makeVote(t, val, chainID, math.MaxInt32, math.MaxInt64, math.MaxInt32, math.MaxInt32, blockID2),
	}
