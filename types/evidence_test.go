...
func TestEvidenceProto(t *testing.T) {
	...
	tests := []struct {
		...
		{"&ConflictingHeadersEvidence empty fail", &ConflictingHeadersEvidence{}, true, true},
		{"&ConflictingHeadersEvidence nil H2", &ConflictingHeadersEvidence{H1: h1, H2: nil}, true, true},
		{"&ConflictingHeadersEvidence nil H1", &ConflictingHeadersEvidence{H1: nil, H2: h2}, true, true},
		// {"&ConflictingHeadersEvidence success", &ConflictingHeadersEvidence{H1: h1, H2: h2}, false, false},
		{"ConflictingHeadersEvidence empty fail", ConflictingHeadersEvidence{}, true, true},
		{"ConflictingHeadersEvidence nil H2", ConflictingHeadersEvidence{H1: h1, H2: nil}, true, true},
		{"ConflictingHeadersEvidence nil H1", ConflictingHeadersEvidence{H1: nil, H2: h2}, true, true},
		{"ConflictingHeadersEvidence success", ConflictingHeadersEvidence{H1: h1, H2: h2}, false, false},
		{"LunaticValidatorEvidence empty fail", LunaticValidatorEvidence{}, true, true},
		{"&LunaticValidatorEvidence empty fail", &LunaticValidatorEvidence{}, true, true},
		{"&LunaticValidatorEvidence empty fail", &LunaticValidatorEvidence{}, true, true},
		{"PotentialAmnesiaEvidence empty fail", PotentialAmnesiaEvidence{}, true, true},
		{"PotentialAmnesiaEvidence nil VoteB", PotentialAmnesiaEvidence{VoteA: v, VoteB: nil}, true, true},
		{"PotentialAmnesiaEvidence nil VoteA", PotentialAmnesiaEvidence{VoteA: nil, VoteB: v2}, true, true},
