...
func TestMaxEvidenceBytes(t *testing.T) {
	...
	ev := &DuplicateVoteEvidence{
		...
		VoteA:  makeVote(t, val, chainID, math.MaxUint32, math.MaxInt64, math.MaxInt32, math.MaxInt32, blockID),
		VoteB:  makeVote(t, val, chainID, math.MaxUint32, math.MaxInt64, math.MaxInt32, math.MaxInt32, blockID2),
	}
...
func TestDuplicateVoteEvidenceValidation(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.testName, func(t *testing.T) {
			...
			vote1 := makeVote(t, val, chainID, math.MaxUint32, math.MaxInt64, math.MaxInt32, 0x02, blockID)
			vote2 := makeVote(t, val, chainID, math.MaxUint32, math.MaxInt64, math.MaxInt32, 0x02, blockID2)
