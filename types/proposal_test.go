...
func TestProposalString(t *testing.T) {
	...
	expected := `Proposal{12345/23456 ({[1 2 3] {111 [98 108 111 99 107 112 97 114 116 115]}}, -1) 000000000000 @ 2018-02-11T07:09:22.765Z}`
	if str != expected {
...
func TestProposalValidateBasic(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Invalid Type", func(p *Proposal) { p.Type = SIGNED_MSG_TYPE_PRECOMMIT_TYPE }, true},
