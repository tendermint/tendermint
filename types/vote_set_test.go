...
func TestAddVote(t *testing.T) {
	...
	voteSet, _, privValidators := randVoteSet(height, round, byte(PrevoteType), 10, 1)
...
func Test2_3MajorityRedux(t *testing.T) {
	height, round := int64(1), 0
	voteSet, _, privValidators := randVoteSet(height, round, byte(PrevoteType), 100, 1)
...
func TestConflicts(t *testing.T) {
	height, round := int64(1), 0
	voteSet, _, privValidators := randVoteSet(height, round, byte(PrevoteType), 4, 1)
...
func TestMakeCommit(t *testing.T) {
	height, round := int64(1), 0
	voteSet, _, privValidators := randVoteSet(height, round, byte(PrecommitType), 10, 1)
