...
func TestVoteString(t *testing.T) {
	...
	expected := `Vote{2(Precommit) 12345/02 @ 2017-12-25T03:00:01.234Z 8B01023386C3 56789:6AF1F4111082   000000000000}`
	if str != expected {
		t.Errorf("Got unexpected string for Vote. Expected:\n%v\nGot:\n%v", expected, str)
	}

	str2 := examplePrevote().String()
	expected = `Vote{1(Prevote) 12345/02 @ 2017-12-25T03:00:01.234Z 8B01023386C3 56789:6AF1F4111082   000000000000}`
	if str2 != expected {
		t.Errorf("Got unexpected string for Vote. Expected:\n%v\nGot:\n%v", expected, str2)
	}
}
