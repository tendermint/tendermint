...
func TestVoteSignBytesTestVectors(t *testing.T) {
	...
	tests := []struct {
		...
		0: {
			...
			[]byte{0x22, 0x2, 0x12, 0x0, 0x2a, 0xb, 0x8, 0x80, 0x92, 0xb8, 0xc3, 0x98, 0xfe, 0xff, 0xff, 0xff, 0x1},
		},
		// with proper (fixed size) height and round (PreCommit):
		1: {
			"", &Vote{Height: 1, Round: 1, Type: tmproto.PrecommitType},
			[]byte{0x8, 0x2, 0x11, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x19, 0x1, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x22, 0x2, 0x12, 0x0, 0x2a, 0xb, 0x8, 0x80, 0x92, 0xb8,
