...
func TestEventBusPublishEventTx(t *testing.T) {
	...
	// PublishEventTx adds all these 3 events, so the query below should work
...
func TestEventBusPublishEventNewBlock(t *testing.T) {
	...
	// PublishEventNewBlock adds the tm.event event, so the query below should work
...
func TestEventBusPublishEventNewBlockHeader(t *testing.T) {
	...
	// PublishEventNewBlockHeader adds the tm.event event, so the query below should work
