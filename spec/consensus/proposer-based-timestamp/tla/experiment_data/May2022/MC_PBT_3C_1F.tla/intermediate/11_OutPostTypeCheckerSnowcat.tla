--------------------- MODULE 11_OutPostTypeCheckerSnowcat ---------------------
...
*)
CInit_si_0 ==
  Skolem((\E t_1n$1 \in [(0 .. 3) -> ({ "c1", "c2", "c3" } \union {"f4"})]:
    Proposer' := t_1n$1))
...
Init_si_0000 ==
  round' := [ p$1 \in { "c1", "c2", "c3" } |-> 0 ]
    /\ Skolem((\E t_1o$1 \in [{ "c1", "c2", "c3" } -> (2 .. 4)]:
      localClock' := t_1o$1))
    /\ realTime' := 0
    ...
    /\ validValue' := [ p$6 \in { "c1", "c2", "c3" } |-> <<"None", -1, -1>> ]
...
Next_si_0001 ==
  (\A p$16 \in { "c1", "c2", "c3" }:
    ...
    /\ Skolem((\E p$17 \in { "c1", "c2", "c3" }:
      step[p$17] = "PREVOTE"
        /\ LET (*
          @type: (() => Set([id: <<Str, Int, Int>>, round: Int, src: Str, type: Str]));
        *)
        PV_si_1 ==
          { m$4 \in msgsPrevote[round[p$17]]: m$4["id"] = <<"None", -1, -1>> }
        IN
...
Next_si_0005 ==
  (\A p$20 \in { "c1", "c2", "c3" }:
    ...
    /\ Skolem((\E p$21 \in { "c1", "c2", "c3" }:
      Skolem((\E v$1 \in { "v0", "v1" }:
        Skolem((\E t$2 \in 0 .. 7:
      ...
      Skolem((\E r$10 \in 0 .. 3:
        r$10 > round[p$23]
          ...
          *)
          ...
          IN
          Skolem((\E MyEvidence$1 \in SUBSET RoundMsgs_si_1:
            LET (*
              @type: (() => Set(Str));
            *)
...
Next_si_0007 ==
  (\A p$24 \in { "c1", "c2", "c3" }:
    ...
    /\ Skolem((\E p$25 \in { "c1", "c2", "c3" }:
      decision[p$25] = <<<<"None", -1, -1>>, -1>>
        /\ Skolem((\E v$2 \in { "v0", "v1" }:
          Skolem((\E t$3 \in 0 .. 7:
            Skolem((\E r$11 \in 0 .. 3:
...
Next_si_0008 ==
  (\A p$26 \in { "c1", "c2", "c3" }:
    ...
    /\ Skolem((\E p$27 \in { "c1", "c2", "c3" }:
      Skolem((\E v$3 \in { "v0", "v1" } \union {"v2"}:
        Skolem((\E t$4 \in 0 .. 7:
              ...
              ((step[p$27] = "PROPOSE" /\ 0 <= vr$3) /\ vr$3 < r_si_12)
                ...
                *)
                ...
                msgsPrevote'
                  := [
                    msgsPrevote EXCEPT
                      ![r_si_12] = msgsPrevote[(r_si_12)] \union {(newMsg_si_4)}
                  ]
...
Next_si_0009 ==
  (\A p$28 \in { "c1", "c2", "c3" }:
    ...
    /\ Skolem((\E p$29 \in { "c1", "c2", "c3" }:
      step[p$29] = "PREVOTE"
        /\ Skolem((\E MyEvidence$2 \in SUBSET (msgsPrevote[round[p$29]]):
          LET (*
            @type: (() => Set(Str));
          *)
...
Next_si_0010 ==
  (\A p$30 \in { "c1", "c2", "c3" }:
    ...
    /\ Skolem((\E p$31 \in { "c1", "c2", "c3" }:
      Skolem((\E v$4 \in { "v0", "v1" } \union {"v2"}:
        Skolem((\E t$5 \in 0 .. 7:
...
Next_si_0011 ==
  (\A p$32 \in { "c1", "c2", "c3" }:
    ...
    /\ Skolem((\E p$33 \in { "c1", "c2", "c3" }:
      Skolem((\E MyEvidence$3 \in SUBSET (msgsPrecommit[round[p$33]]):
        LET (*
          @type: (() => Set(Str));
        *)
...
Next_si_0015 ==
  (\A p$38 \in { "c1", "c2", "c3" }:
    ...
    /\ Skolem((\E p$39 \in { "c1", "c2", "c3" }:
      Skolem((\E v$7 \in { "v0", "v1" }:
        Skolem((\E t$7 \in 0 .. 7:
...
*)
VCNotInv_si_0 ==
  Skolem((\E p$41 \in { "c1", "c2", "c3" }:
    Skolem((\E q$14 \in { "c1", "c2", "c3" }:
