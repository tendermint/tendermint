...
Init_si_0000 ==
  round' := [ p$1 \in { "c1", "c2" } |-> 0 ]
    /\ (\E t_1o$1 \in [{ "c1", "c2" } -> (2 .. 4)]: localClock' := t_1o$1)
    /\ realTime' := 0
          ...
          \E MyEvidence$2 \in SUBSET RoundMsgs_si_1:
            ...
            *)
            ...
            LET (*@type: (() => Set(Str)); *) t_2p == Faster_si_1 IN
              \E t_2n \in t_2p: \E t_2o \in t_2p: ~(t_2n = t_2o)
