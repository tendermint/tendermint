...
information can be found in either [data structures](https://github.com/tendermint/tendermint/blob/v0.35.x/spec/core/data_structures.md)
or [accountability](https://github.com/tendermint/tendermint/blob/v0.35.x/spec/light-client/accountability/)
