...
// StateSource is an autogenerated mock type for the StateSource type
type StateSource struct {
	mock.Mock
}

// AppHash provides a mock function with given fields: height
func (_m *StateSource) AppHash(height uint64) ([]byte, error) {
...
func (_m *StateSource) Commit(height uint64) (*types.Commit, error) {
	ret := _m.Called(height)
...
func (_m *StateSource) State(height uint64) (state.State, error) {
	ret := _m.Called(height)
