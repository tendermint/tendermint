...
cd $GOPATH/src/github.com/eris-ltd/tendermint/DOCKER
...
# Run tendermint node
docker run --name tmnode --volumes-from tmdata -d -p 46656:46656 -p 46657:46657 -e TMREPO="github.com/eris-ltd/tendermint" -e TMHEAD="origin/develop" tmbase
