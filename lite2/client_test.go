...
func Test_Witness_Dropout(t *testing.T) {
	const (
		chainID = "Test_Witness_Dropout"
	)
	...
	_, err = c.VerifyHeaderAtHeight(2, bTime.Add(30*time.Minute).Add(1*time.Second))
