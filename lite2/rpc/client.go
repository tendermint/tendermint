...
func (c *Client) TxSearch(query string, prove bool, page, perPage int, sortOrder string) (*ctypes.ResultTxSearch, error) {
	return c.next.TxSearch(query, prove, page, perPage, sortOrder)
}
