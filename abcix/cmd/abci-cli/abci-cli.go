...
import (
	...
	"github.com/tendermint/tendermint/abcix/server"
	"github.com/tendermint/tendermint/abcix/types"
	"github.com/tendermint/tendermint/abcix/version"
	"github.com/tendermint/tendermint/proto/tendermint/crypto"
)

// client is a global variable so it can be reused by the console
var (
	client abcixcli.Client
	logger log.Logger
)
...
var RootCmd = &cobra.Command{
	...
	PersistentPreRunE: func(cmd *cobra.Command, args []string) error {
		...
		if client == nil {
			var err error
			client, err = abcixcli.NewClient(flagAddress, flagAbci, false)
			if err != nil {
				return err
			}
