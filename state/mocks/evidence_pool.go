...
func (_m *EvidencePool) CheckEvidence(_a0 types.EvidenceList) ([]byte, error) {
	ret := _m.Called(_a0)

	var r0 []byte
	if rf, ok := ret.Get(0).(func(types.EvidenceList) []byte); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]byte)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(types.EvidenceList) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
