...
import (
	...
	consensus "github.com/tendermint/tendermint/pkg/consensus"
...
func (_m *Store) LoadConsensusParams(_a0 int64) (consensus.ConsensusParams, error) {
	ret := _m.Called(_a0)

	var r0 consensus.ConsensusParams
	if rf, ok := ret.Get(0).(func(int64) consensus.ConsensusParams); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(consensus.ConsensusParams)
	}
...
func (_m *Store) LoadValidators(_a0 int64) (*consensus.ValidatorSet, error) {
	ret := _m.Called(_a0)

	var r0 *consensus.ValidatorSet
	if rf, ok := ret.Get(0).(func(int64) *consensus.ValidatorSet); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*consensus.ValidatorSet)
		}
	}
...
func (_m *Store) SaveValidatorSets(_a0 int64, _a1 int64, _a2 *consensus.ValidatorSet) error {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 error
	if rf, ok := ret.Get(0).(func(int64, int64, *consensus.ValidatorSet) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
