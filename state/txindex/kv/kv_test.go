...
func TestTxSearch(t *testing.T) {
	...
	txResult := txResultWithEvents([]abci.Event{
		{Type: "account", Attributes: []kv.KVPair{{Key: []byte("number"), Value: []byte("1")}}},
		{Type: "account", Attributes: []kv.KVPair{{Key: []byte("owner"), Value: []byte("Ivan")}}},
		{Type: "", Attributes: []kv.KVPair{{Key: []byte("not_allowed"), Value: []byte("Vlad")}}},
	})
...
func TestTxSearchOneTxWithMultipleSameTagsButDifferentValues(t *testing.T) {
	...
	txResult := txResultWithEvents([]abci.Event{
		{Type: "account", Attributes: []kv.KVPair{{Key: []byte("number"), Value: []byte("1")}}},
		{Type: "account", Attributes: []kv.KVPair{{Key: []byte("number"), Value: []byte("2")}}},
	})
...
func TestTxSearchMultipleTxs(t *testing.T) {
	...
	txResult3 := txResultWithEvents([]abci.Event{
		{Type: "account", Attributes: []kv.KVPair{{Key: []byte("number"), Value: []byte("3")}}},
	})
	...
	txResult4 := txResultWithEvents([]abci.Event{
		{Type: "account", Attributes: []kv.KVPair{{Key: []byte("number.id"), Value: []byte("1")}}},
	})
