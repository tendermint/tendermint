...
@erikgrinaker, @whunmr, @cosmostuba, haasted 
...
- [rpc] [\#4077](https://github.com/tendermint/tendermint/pull/4077) Added support for `EXISTS` clause to the Websocket query interface. (@haasted)
- [privval] [\#4115](https://github.com/tendermint/tendermint/pull/4115) Add `SignerDialerEndpointRetryWaitInterval` option (@cosmostuba)
...
- [state] [\#4095](https://github.com/tendermint/tendermint/pull/4095) txindex/kv: Return an error if there's one when the user searches for a tx (hash=X)
