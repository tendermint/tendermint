...
[misconfiguration](https://docs.tendermint.com/latest/tendermint-core/using-tendermint.html)
...
- [libs/db] [\#3611](https://github.com/tendermint/tendermint/issues/3611) Conditional compilation
  * Use `cleveldb` tag instead of `gcc` to compile Tendermint with CLevelDB or
    ...
    https://docs.tendermint.com/latest/introduction/install.html#compile-with-cleveldb-support)
