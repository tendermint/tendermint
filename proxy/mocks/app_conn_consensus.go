...
// CheckBlockSync provides a mock function with given fields: _a0
func (_m *AppConnConsensus) CheckBlockSync(_a0 types.RequestCheckBlock) (*types.ResponseCheckBlock, error) {
	ret := _m.Called(_a0)

	var r0 *types.ResponseCheckBlock
	if rf, ok := ret.Get(0).(func(types.RequestCheckBlock) *types.ResponseCheckBlock); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.ResponseCheckBlock)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(types.RequestCheckBlock) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
