...
Create file `$KVSTORE_HOME/src/main/java/io/example/KVStoreApp.java` with following context:
```java
package io.example;
...
Create file `$KVSTORE_HOME/src/main/java/io/example/GrpcServer.java`:
```java
package io.example;
