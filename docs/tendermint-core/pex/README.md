...
See the [trustmetric](https://github.com/tendermint/tendermint/blob/v0.35.x/docs/architecture/adr-006-trust-metric.md)
and [trustmetric useage](https://github.com/tendermint/tendermint/blob/v0.35.x/docs/architecture/adr-007-trust-metric-usage.md)
