module.exports = {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      smallprint:
          'The development of the Tendermint project is led primarily by [Interchain GmbH](https://interchain.berlin/). Funding for this development comes primarily from the Interchain Foundation, a Swiss non-profit.',
      links: [
        {
          title: 'Documentation',
          children: [
