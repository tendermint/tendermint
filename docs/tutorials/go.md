...
specification"](https://docs.tendermint.com/latest/spec/abci/apps.html#gas).
...
[here](https://docs.tendermint.com/latest/spec/abci/).
...
guide](https://docs.tendermint.com/latest/introduction/install.html). If you're
...
[here](https://docs.tendermint.com/latest/tendermint-core/configuration.html).
...
deeper, read [the docs](https://docs.tendermint.com/latest/).
