...
social consensus). It is assumed that *inithead* satisfies the lite client invariant. (If *inithead* has been correctly generated by ßTendermint consensus, the invariant follows from the Tendermint Failure Model.)
