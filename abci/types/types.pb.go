...
type Request_CheckQuorumSignature struct {
	CheckQuorumSignature *RequestCheckQuorumSignature `protobuf:"bytes,9,opt,name=check_quorum_signature,json=checkQuorumSignature,proto3,oneof" json:"check_quorum_signature,omitempty"`
}
type Request_DeliverTx struct {
	DeliverTx *RequestDeliverTx `protobuf:"bytes,10,opt,name=deliver_tx,json=deliverTx,proto3,oneof" json:"deliver_tx,omitempty"`
}
...
func (*Request_CheckQuorumSignature) isRequest_Value() {}
...
func (m *Request) GetCheckQuorumSignature() *RequestCheckQuorumSignature {
	if x, ok := m.GetValue().(*Request_CheckQuorumSignature); ok {
		return x.CheckQuorumSignature
	}
	return nil
}
...
func (*Request) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Request_CheckTx)(nil),
		(*Request_CheckQuorumSignature)(nil),
...
type RequestCheckQuorumSignature struct {
	CoreHeight uint32 `protobuf:"varint,1,opt,name=coreHeight,proto3" json:"coreHeight,omitempty"`
	QuorumType uint32 `protobuf:"varint,2,opt,name=quorumType,proto3" json:"quorumType,omitempty"`
	RequestId  []byte `protobuf:"bytes,3,opt,name=requestId,proto3" json:"requestId,omitempty"`
	Digest     []byte `protobuf:"bytes,4,opt,name=digest,proto3" json:"digest,omitempty"`
	Signature  []byte `protobuf:"bytes,5,opt,name=signature,proto3" json:"signature,omitempty"`
}

func (m *RequestCheckQuorumSignature) Reset()         { *m = RequestCheckQuorumSignature{} }
func (m *RequestCheckQuorumSignature) String() string { return proto.CompactTextString(m) }
func (*RequestCheckQuorumSignature) ProtoMessage()    {}
func (*RequestCheckQuorumSignature) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{9}
}
func (m *RequestCheckQuorumSignature) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestCheckQuorumSignature) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestCheckQuorumSignature.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestCheckQuorumSignature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestCheckQuorumSignature.Merge(m, src)
}
func (m *RequestCheckQuorumSignature) XXX_Size() int {
	return m.Size()
}
func (m *RequestCheckQuorumSignature) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestCheckQuorumSignature.DiscardUnknown(m)
}

var xxx_messageInfo_RequestCheckQuorumSignature proto.InternalMessageInfo

func (m *RequestCheckQuorumSignature) GetCoreHeight() uint32 {
	if m != nil {
		return m.CoreHeight
	}
	return 0
...
func (m *RequestCheckQuorumSignature) GetQuorumType() uint32 {
	if m != nil {
		return m.QuorumType
	}
	return 0
...
func (m *RequestCheckQuorumSignature) GetRequestId() []byte {
	if m != nil {
		return m.RequestId
	}
	return nil
...
func (m *RequestCheckQuorumSignature) GetDigest() []byte {
	if m != nil {
		return m.Digest
	}
	return nil
...
func (m *RequestCheckQuorumSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
type Response_CheckQuorumSignature struct {
	CheckQuorumSignature *ResponseCheckQuorumSignature `protobuf:"bytes,10,opt,name=check_quorum_signature,json=checkQuorumSignature,proto3,oneof" json:"check_quorum_signature,omitempty"`
}
type Response_DeliverTx struct {
	DeliverTx *ResponseDeliverTx `protobuf:"bytes,11,opt,name=deliver_tx,json=deliverTx,proto3,oneof" json:"deliver_tx,omitempty"`
}
type Response_EndBlock struct {
	EndBlock *ResponseEndBlock `protobuf:"bytes,12,opt,name=end_block,json=endBlock,proto3,oneof" json:"end_block,omitempty"`
}
type Response_Commit struct {
	Commit *ResponseCommit `protobuf:"bytes,13,opt,name=commit,proto3,oneof" json:"commit,omitempty"`
}
type Response_ListSnapshots struct {
	ListSnapshots *ResponseListSnapshots `protobuf:"bytes,14,opt,name=list_snapshots,json=listSnapshots,proto3,oneof" json:"list_snapshots,omitempty"`
}
type Response_OfferSnapshot struct {
	OfferSnapshot *ResponseOfferSnapshot `protobuf:"bytes,15,opt,name=offer_snapshot,json=offerSnapshot,proto3,oneof" json:"offer_snapshot,omitempty"`
}
type Response_LoadSnapshotChunk struct {
	LoadSnapshotChunk *ResponseLoadSnapshotChunk `protobuf:"bytes,16,opt,name=load_snapshot_chunk,json=loadSnapshotChunk,proto3,oneof" json:"load_snapshot_chunk,omitempty"`
}
type Response_ApplySnapshotChunk struct {
	ApplySnapshotChunk *ResponseApplySnapshotChunk `protobuf:"bytes,17,opt,name=apply_snapshot_chunk,json=applySnapshotChunk,proto3,oneof" json:"apply_snapshot_chunk,omitempty"`
}
...
func (*Response_CheckQuorumSignature) isResponse_Value() {}
...
func (m *Response) GetCheckQuorumSignature() *ResponseCheckQuorumSignature {
	if x, ok := m.GetValue().(*Response_CheckQuorumSignature); ok {
		return x.CheckQuorumSignature
	}
	return nil
}
...
func (*Response) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Response_CheckQuorumSignature)(nil),
...
type ResponseCheckQuorumSignature struct {
	Code uint32 `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
}

func (m *ResponseCheckQuorumSignature) Reset()         { *m = ResponseCheckQuorumSignature{} }
func (m *ResponseCheckQuorumSignature) String() string { return proto.CompactTextString(m) }
func (*ResponseCheckQuorumSignature) ProtoMessage()    {}
func (*ResponseCheckQuorumSignature) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{27}
}
func (m *ResponseCheckQuorumSignature) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseCheckQuorumSignature) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseCheckQuorumSignature.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseCheckQuorumSignature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseCheckQuorumSignature.Merge(m, src)
}
func (m *ResponseCheckQuorumSignature) XXX_Size() int {
	return m.Size()
}
func (m *ResponseCheckQuorumSignature) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseCheckQuorumSignature.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseCheckQuorumSignature proto.InternalMessageInfo

func (m *ResponseCheckQuorumSignature) GetCode() uint32 {
	if m != nil {
		return m.Code
	}
	return 0
...
type ResponseEndBlock struct {
	...
	NextChainLockUpdate   *types1.ChainLock `protobuf:"bytes,4,opt,name=next_chain_lock_update,json=nextChainLockUpdate,proto3" json:"next_chain_lock_update,omitempty"`
}
...
func (m *ResponseEndBlock) GetNextChainLockUpdate() *types1.ChainLock {
	if m != nil {
		return m.NextChainLockUpdate
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*RequestCheckQuorumSignature)(nil), "tendermint.abci.RequestCheckQuorumSignature")
	...
	proto.RegisterType((*ResponseCheckQuorumSignature)(nil), "tendermint.abci.ResponseCheckQuorumSignature")
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
type ABCIApplicationClient interface {
	...
	CheckQuorumSignature(ctx context.Context, in *RequestCheckQuorumSignature, opts ...grpc.CallOption) (*ResponseCheckQuorumSignature, error)
...
func (c *aBCIApplicationClient) CheckQuorumSignature(ctx context.Context, in *RequestCheckQuorumSignature, opts ...grpc.CallOption) (*ResponseCheckQuorumSignature, error) {
	out := new(ResponseCheckQuorumSignature)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCIApplication/CheckQuorumSignature", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ABCIApplicationServer interface {
	...
	CheckQuorumSignature(context.Context, *RequestCheckQuorumSignature) (*ResponseCheckQuorumSignature, error)
...
func (*UnimplementedABCIApplicationServer) CheckQuorumSignature(ctx context.Context, req *RequestCheckQuorumSignature) (*ResponseCheckQuorumSignature, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckQuorumSignature not implemented")
}
...
func _ABCIApplication_CheckQuorumSignature_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestCheckQuorumSignature)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIApplicationServer).CheckQuorumSignature(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCIApplication/CheckQuorumSignature",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIApplicationServer).CheckQuorumSignature(ctx, req.(*RequestCheckQuorumSignature))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCIApplication_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckQuorumSignature",
			Handler:    _ABCIApplication_CheckQuorumSignature_Handler,
		},
		{
			MethodName: "Query",
...
func (m *Request_CheckQuorumSignature) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_CheckQuorumSignature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CheckQuorumSignature != nil {
		{
			size, err := m.CheckQuorumSignature.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RequestCheckQuorumSignature) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestCheckQuorumSignature) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestCheckQuorumSignature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.CoreHeight != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.CoreHeight))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Response_CheckQuorumSignature) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_CheckQuorumSignature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CheckQuorumSignature != nil {
		{
			size, err := m.CheckQuorumSignature.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ResponseCheckQuorumSignature) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseCheckQuorumSignature) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseCheckQuorumSignature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ResponseEndBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.NextChainLockUpdate != nil {
		{
			size, err := m.NextChainLockUpdate.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Request_CheckQuorumSignature) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestCheckQuorumSignature) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CoreHeight != 0 {
		n += 1 + sovTypes(uint64(m.CoreHeight))
	}
	if m.QuorumType != 0 {
...
func (m *Response_CheckQuorumSignature) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseCheckQuorumSignature) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CheckQuorumSignature", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RequestCheckQuorumSignature{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Request_CheckQuorumSignature{v}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
...
func (m *RequestCheckQuorumSignature) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestCheckQuorumSignature: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestCheckQuorumSignature: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CoreHeight", wireType)
			}
			m.CoreHeight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CoreHeight |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.QuorumType |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			v := &ResponseCheckQuorumSignature{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Response_CheckQuorumSignature{v}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeliverTx", wireType)
...
func (m *ResponseCheckQuorumSignature) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseCheckQuorumSignature: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseCheckQuorumSignature: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ResponseEndBlock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NextChainLockUpdate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.NextChainLockUpdate == nil {
				m.NextChainLockUpdate = &types1.ChainLock{}
			}
			if err := m.NextChainLockUpdate.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
