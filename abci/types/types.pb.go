...
type Request_RecheckTx struct {
	RecheckTx *RequestRecheckTx `protobuf:"bytes,13,opt,name=recheck_tx,json=recheckTx,oneof"`
}
...
func (*Request_RecheckTx) isRequest_Value()  {}
...
func (m *Request) GetRecheckTx() *RequestRecheckTx {
	if x, ok := m.GetValue().(*Request_RecheckTx); ok {
		return x.RecheckTx
	}
	return nil
}
...
func _Request_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Request_RecheckTx:
		_ = b.EncodeVarint(13<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RecheckTx); err != nil {
			return err
		}
	case nil:
	default:
...
func _Request_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 12: // value.commit
		...
		return true, err
	case 13: // value.recheck_tx
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RequestRecheckTx)
		err := b.DecodeMessage(msg)
		m.Value = &Request_RecheckTx{msg}
		return true, err
	default:
		return false, nil
	}
...
type RequestRecheckTx struct {
	Tx []byte `protobuf:"bytes,1,opt,name=tx,proto3" json:"tx,omitempty"`
}

func (m *RequestRecheckTx) Reset()                    { *m = RequestRecheckTx{} }
func (m *RequestRecheckTx) String() string            { return proto.CompactTextString(m) }
func (*RequestRecheckTx) ProtoMessage()               {}
func (*RequestRecheckTx) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{9} }

func (m *RequestRecheckTx) GetTx() []byte {
	if m != nil {
		return m.Tx
	}
	return nil
...
func (*RequestDeliverTx) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{10} }
...
func (*RequestCommit) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{12} }
...
func (*Response) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{13} }
...
type Response_RecheckTx struct {
	RecheckTx *ResponseRecheckTx `protobuf:"bytes,13,opt,name=recheck_tx,json=recheckTx,oneof"`
}
...
func (*Response_RecheckTx) isResponse_Value()  {}
...
func (m *Response) GetRecheckTx() *ResponseRecheckTx {
	if x, ok := m.GetValue().(*Response_RecheckTx); ok {
		return x.RecheckTx
	}
	return nil
}
...
func _Response_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 13: // value.recheck_tx
		...
		msg := new(ResponseRecheckTx)
		err := b.DecodeMessage(msg)
		m.Value = &Response_RecheckTx{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*ResponseException) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{14} }
...
func (*ResponseEcho) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{15} }
...
func (*ResponseFlush) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{16} }
...
func (*ResponseInfo) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{17} }
...
func (*ResponseSetOption) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{18} }
...
func (*ResponseInitChain) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{19} }
...
func (*ResponseBeginBlock) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{21} }
...
func (*ResponseCheckTx) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{22} }
...
func (m *ResponseRecheckTx) Reset()                    { *m = ResponseRecheckTx{} }
func (m *ResponseRecheckTx) String() string            { return proto.CompactTextString(m) }
func (*ResponseRecheckTx) ProtoMessage()               {}
func (*ResponseRecheckTx) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{23} }

func (m *ResponseRecheckTx) GetCode() uint32 {
	if m != nil {
		return m.Code
	}
	return 0
...
func (m *ResponseRecheckTx) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *ResponseRecheckTx) GetLog() string {
	if m != nil {
		return m.Log
	}
	return ""
...
func (m *ResponseRecheckTx) GetInfo() string {
	if m != nil {
		return m.Info
	}
	return ""
...
func (m *ResponseRecheckTx) GetGasWanted() int64 {
	if m != nil {
		return m.GasWanted
	}
	return 0
...
func (m *ResponseRecheckTx) GetGasUsed() int64 {
	if m != nil {
		return m.GasUsed
	}
	return 0
...
func (m *ResponseRecheckTx) GetTags() []common.KVPair {
	if m != nil {
		return m.Tags
	}
	return nil
...
func (*ResponseDeliverTx) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{24} }
...
func (*ResponseEndBlock) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{25} }
...
func (*ResponseCommit) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{26} }
...
func (*LastCommitInfo) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{31} }
...
func (*Header) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{32} }
...
func init() {
	...
	proto.RegisterType((*RequestRecheckTx)(nil), "types.RequestRecheckTx")
	golang_proto.RegisterType((*RequestRecheckTx)(nil), "types.RequestRecheckTx")
	...
	proto.RegisterType((*ResponseRecheckTx)(nil), "types.ResponseRecheckTx")
	golang_proto.RegisterType((*ResponseRecheckTx)(nil), "types.ResponseRecheckTx")
...
func (this *Request_RecheckTx) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Request_RecheckTx)
	if !ok {
		that2, ok := that.(Request_RecheckTx)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.RecheckTx.Equal(that1.RecheckTx) {
		return false
	}
	return true
}
...
func (this *RequestRecheckTx) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*RequestRecheckTx)
	if !ok {
		that2, ok := that.(RequestRecheckTx)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *Response_RecheckTx) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Response_RecheckTx)
	if !ok {
		that2, ok := that.(Response_RecheckTx)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ResponseRecheckTx) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ResponseRecheckTx)
	if !ok {
		that2, ok := that.(ResponseRecheckTx)
		if ok {
			that1 = &that2
		} else {
			return false
...
type ABCIApplicationClient interface {
	...
	RecheckTx(ctx context.Context, in *RequestRecheckTx, opts ...grpc.CallOption) (*ResponseRecheckTx, error)
...
func (c *aBCIApplicationClient) RecheckTx(ctx context.Context, in *RequestRecheckTx, opts ...grpc.CallOption) (*ResponseRecheckTx, error) {
	out := new(ResponseRecheckTx)
	err := grpc.Invoke(ctx, "/types.ABCIApplication/RecheckTx", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ABCIApplicationServer interface {
	...
	RecheckTx(context.Context, *RequestRecheckTx) (*ResponseRecheckTx, error)
...
func _ABCIApplication_RecheckTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestRecheckTx)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIApplicationServer).RecheckTx(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/types.ABCIApplication/RecheckTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIApplicationServer).RecheckTx(ctx, req.(*RequestRecheckTx))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCIApplication_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RecheckTx",
			Handler:    _ABCIApplication_RecheckTx_Handler,
		},
		{
			MethodName: "Query",
...
func (m *Request_RecheckTx) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RecheckTx != nil {
		dAtA[i] = 0x6a
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.RecheckTx.Size()))
		n12, err := m.RecheckTx.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *RequestInitChain) MarshalTo(dAtA []byte) (int, error) {
	...
	n14, err := types1.StdTimeMarshalTo(m.Time, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n14
...
func (m *RequestRecheckTx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RequestRecheckTx) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Response_RecheckTx) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RecheckTx != nil {
		dAtA[i] = 0x6a
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.RecheckTx.Size()))
		n31, err := m.RecheckTx.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
...
func (m *ResponseRecheckTx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ResponseRecheckTx) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ConsensusParams) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TxSize != nil {
		...
		n35, err := m.TxSize.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
	...
	if m.BlockGossip != nil {
		...
		n36, err := m.BlockGossip.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *Header) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintTypes(dAtA, i, uint64(types1.SizeOfStdTime(m.Time)))
	n37, err := types1.StdTimeMarshalTo(m.Time, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n37
	...
	n38, err := m.Proposer.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n38
...
func (m *Evidence) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintTypes(dAtA, i, uint64(types1.SizeOfStdTime(m.Time)))
	n42, err := types1.StdTimeMarshalTo(m.Time, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n42
...
func NewPopulatedRequest(r randyTypes, easy bool) *Request {
	...
	case 13:
		this.Value = NewPopulatedRequest_RecheckTx(r, easy)
	case 19:
...
func NewPopulatedRequest_RecheckTx(r randyTypes, easy bool) *Request_RecheckTx {
	this := &Request_RecheckTx{}
	this.RecheckTx = NewPopulatedRequestRecheckTx(r, easy)
	return this
}
...
func NewPopulatedRequestRecheckTx(r randyTypes, easy bool) *RequestRecheckTx {
	this := &RequestRecheckTx{}
	v12 := r.Intn(100)
...
func NewPopulatedResponse(r randyTypes, easy bool) *Response {
	...
	case 13:
		this.Value = NewPopulatedResponse_RecheckTx(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedResponse_RecheckTx(r randyTypes, easy bool) *Response_RecheckTx {
	this := &Response_RecheckTx{}
	this.RecheckTx = NewPopulatedResponseRecheckTx(r, easy)
	return this
}
...
func NewPopulatedResponseRecheckTx(r randyTypes, easy bool) *ResponseRecheckTx {
	this := &ResponseRecheckTx{}
	this.Code = uint32(r.Uint32())
	v25 := r.Intn(100)
...
func NewPopulatedResponseEndBlock(r randyTypes, easy bool) *ResponseEndBlock {
	...
	if r.Intn(10) != 0 {
		v31 := r.Intn(5)
		this.ValidatorUpdates = make([]Validator, v31)
		for i := 0; i < v31; i++ {
			v32 := NewPopulatedValidator(r, easy)
	...
	if r.Intn(10) != 0 {
		v33 := r.Intn(5)
		this.Tags = make([]common.KVPair, v33)
		for i := 0; i < v33; i++ {
			v34 := common.NewPopulatedKVPair(r, easy)
			this.Tags[i] = *v34
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedLastCommitInfo(r randyTypes, easy bool) *LastCommitInfo {
	...
	if r.Intn(10) != 0 {
		v36 := r.Intn(5)
		this.Validators = make([]SigningValidator, v36)
		for i := 0; i < v36; i++ {
			v37 := NewPopulatedSigningValidator(r, easy)
			this.Validators[i] = *v37
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedHeader(r randyTypes, easy bool) *Header {
	...
	v38 := types1.NewPopulatedStdTime(r, easy)
	this.Time = *v38
	...
	v39 := r.Intn(100)
	this.LastBlockHash = make([]byte, v39)
	for i := 0; i < v39; i++ {
...
func NewPopulatedValidator(r randyTypes, easy bool) *Validator {
	this := &Validator{}
	v43 := r.Intn(100)
	this.Address = make([]byte, v43)
	for i := 0; i < v43; i++ {
		this.Address[i] = byte(r.Intn(256))
	}
	v44 := NewPopulatedPubKey(r, easy)
	this.PubKey = *v44
...
func NewPopulatedSigningValidator(r randyTypes, easy bool) *SigningValidator {
	...
	v45 := NewPopulatedValidator(r, easy)
	this.Validator = *v45
...
func NewPopulatedEvidence(r randyTypes, easy bool) *Evidence {
	...
	v48 := types1.NewPopulatedStdTime(r, easy)
	this.Time = *v48
...
func randFieldTypes(dAtA []byte, r randyTypes, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateTypes(dAtA, uint64(v50))
	case 1:
		dAtA = encodeVarintPopulateTypes(dAtA, uint64(key))
...
func (m *Request_RecheckTx) Size() (n int) {
	var l int
	_ = l
	if m.RecheckTx != nil {
		l = m.RecheckTx.Size()
...
func (m *RequestRecheckTx) Size() (n int) {
	var l int
	_ = l
	l = len(m.Tx)
	if l > 0 {
...
func (m *Response_RecheckTx) Size() (n int) {
	var l int
	_ = l
	if m.RecheckTx != nil {
		l = m.RecheckTx.Size()
...
func (m *ResponseRecheckTx) Size() (n int) {
	var l int
	_ = l
	if m.Code != 0 {
		n += 1 + sovTypes(uint64(m.Code))
...
func (m *RequestRecheckTx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestRecheckTx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestRecheckTx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ResponseRecheckTx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseRecheckTx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseRecheckTx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorTypes = []byte{
	...
	,
}
