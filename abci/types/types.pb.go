...
type ResponseInfo struct {
	...
	LastBlockAppData []byte `protobuf:"bytes,4,opt,name=last_block_app_data,json=lastBlockAppData,proto3" json:"last_block_app_data,omitempty"`
...
func (m *ResponseInfo) GetLastBlockAppData() []byte {
	if m != nil {
		return m.LastBlockAppData
	}
	return nil
}
...
func (m *ResponseCommit) GetAppData() []byte {
	if m != nil {
		return m.AppData
	}
	return nil
...
func (m *ResponseCommit) GetAppHash() []byte {
	if m != nil {
		return m.AppHash
	}
	return nil
...
type Header struct {
	...
	AppData        []byte `protobuf:"bytes,8,opt,name=app_data,json=appData,proto3" json:"app_data,omitempty"`
	AppHash        []byte `protobuf:"bytes,9,opt,name=app_hash,json=appHash,proto3" json:"app_hash,omitempty"`
	// consensus
	Proposer Validator `protobuf:"bytes,10,opt,name=proposer" json:"proposer"`
}
...
var fileDescriptorTypes = []byte{
	...
	,
}
