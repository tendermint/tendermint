...
type Request_VoteExtension struct {
	VoteExtension *RequestVoteExtension `protobuf:"bytes,15,opt,name=vote_extension,json=voteExtension,proto3,oneof" json:"vote_extension,omitempty"`
}
type Request_VerifyVoteExtension struct {
	VerifyVoteExtension *RequestVerifyVoteExtension `protobuf:"bytes,16,opt,name=verify_vote_extension,json=verifyVoteExtension,proto3,oneof" json:"verify_vote_extension,omitempty"`
}
...
func (*Request_VoteExtension) isRequest_Value()       {}
...
func (m *Request) GetVoteExtension() *RequestVoteExtension {
	if x, ok := m.GetValue().(*Request_VoteExtension); ok {
...
type RequestVoteExtension struct {
	Height uint64 `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
	Round  uint64 `protobuf:"varint,2,opt,name=round,proto3" json:"round,omitempty"`
}

func (m *RequestVoteExtension) Reset()         { *m = RequestVoteExtension{} }
func (m *RequestVoteExtension) String() string { return proto.CompactTextString(m) }
func (*RequestVoteExtension) ProtoMessage()    {}
func (*RequestVoteExtension) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{15}
}
func (m *RequestVoteExtension) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestVoteExtension) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestVoteExtension.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestVoteExtension) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestVoteExtension.Merge(m, src)
}
func (m *RequestVoteExtension) XXX_Size() int {
	return m.Size()
}
func (m *RequestVoteExtension) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestVoteExtension.DiscardUnknown(m)
}

var xxx_messageInfo_RequestVoteExtension proto.InternalMessageInfo

func (m *RequestVoteExtension) GetHeight() uint64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (m *RequestVoteExtension) GetRound() uint64 {
	if m != nil {
		return m.Round
	}
	return 0
...
type RequestVerifyVoteExtension struct {
	Extension types1.VoteExtension `protobuf:"bytes,1,opt,name=extension,proto3" json:"extension"`
}
...
func (m *RequestVerifyVoteExtension) GetExtension() types1.VoteExtension {
	if m != nil {
		return m.Extension
	}
	return types1.VoteExtension{}
}
...
type Response_VoteExtension struct {
	VoteExtension *ResponseVoteExtension `protobuf:"bytes,16,opt,name=vote_extension,json=voteExtension,proto3,oneof" json:"vote_extension,omitempty"`
}
type Response_VerifyVoteExtension struct {
	VerifyVoteExtension *ResponseVerifyVoteExtension `protobuf:"bytes,17,opt,name=verify_vote_extension,json=verifyVoteExtension,proto3,oneof" json:"verify_vote_extension,omitempty"`
}
...
func (*Response_VoteExtension) isResponse_Value()       {}
...
func (m *Response) GetVoteExtension() *ResponseVoteExtension {
	if x, ok := m.GetValue().(*Response_VoteExtension); ok {
		return x.VoteExtension
	}
	return nil
}
...
type ResponseVoteExtension struct {
	Extension *types1.VoteExtension `protobuf:"bytes,1,opt,name=extension,proto3" json:"extension,omitempty"`
}

func (m *ResponseVoteExtension) Reset()         { *m = ResponseVoteExtension{} }
func (m *ResponseVoteExtension) String() string { return proto.CompactTextString(m) }
func (*ResponseVoteExtension) ProtoMessage()    {}
func (*ResponseVoteExtension) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{33}
}
func (m *ResponseVoteExtension) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseVoteExtension) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseVoteExtension.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseVoteExtension) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseVoteExtension.Merge(m, src)
}
func (m *ResponseVoteExtension) XXX_Size() int {
	return m.Size()
}
func (m *ResponseVoteExtension) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseVoteExtension.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseVoteExtension proto.InternalMessageInfo

func (m *ResponseVoteExtension) GetExtension() *types1.VoteExtension {
	if m != nil {
		return m.Extension
	}
	return nil
...
func (m *ResponseVerifyVoteExtension) GetCode() uint32 {
	if m != nil {
		return m.Code
	}
	return 0
...
func (m *ResponseVerifyVoteExtension) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *ResponseVerifyVoteExtension) GetLog() string {
	if m != nil {
		return m.Log
	}
	return ""
...
func (m *ResponseVerifyVoteExtension) GetInfo() string {
	if m != nil {
		return m.Info
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*RequestVoteExtension)(nil), "tendermint.abci.RequestVoteExtension")
	...
	proto.RegisterType((*ResponseVoteExtension)(nil), "tendermint.abci.ResponseVoteExtension")
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
type ABCIApplicationClient interface {
	...
	VoteExtension(ctx context.Context, in *RequestVoteExtension, opts ...grpc.CallOption) (*ResponseVoteExtension, error)
...
func (c *aBCIApplicationClient) VoteExtension(ctx context.Context, in *RequestVoteExtension, opts ...grpc.CallOption) (*ResponseVoteExtension, error) {
	out := new(ResponseVoteExtension)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCIApplication/VoteExtension", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ABCIApplicationServer interface {
	...
	VoteExtension(context.Context, *RequestVoteExtension) (*ResponseVoteExtension, error)
...
func (*UnimplementedABCIApplicationServer) VoteExtension(ctx context.Context, req *RequestVoteExtension) (*ResponseVoteExtension, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VoteExtension not implemented")
}
...
func _ABCIApplication_VoteExtension_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestVoteExtension)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIApplicationServer).VoteExtension(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCIApplication/VoteExtension",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIApplicationServer).VoteExtension(ctx, req.(*RequestVoteExtension))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCIApplication_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VoteExtension",
			Handler:    _ABCIApplication_VoteExtension_Handler,
		},
		{
...
func (m *Request_VoteExtension) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_VoteExtension) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *RequestVoteExtension) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestVoteExtension) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestVoteExtension) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Response_VoteExtension) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_VoteExtension) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.VoteExtension != nil {
		{
			size, err := m.VoteExtension.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ResponseVoteExtension) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseVoteExtension) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseVoteExtension) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Request_VoteExtension) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestVoteExtension) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_VoteExtension) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseVoteExtension) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			...
			v := &RequestVoteExtension{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Request_VoteExtension{v}
			iNdEx = postIndex
		case 16:
			if wireType != 2 {
...
func (m *RequestVoteExtension) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestVoteExtension: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestVoteExtension: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			...
			v := &ResponseVoteExtension{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Response_VoteExtension{v}
			iNdEx = postIndex
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VerifyVoteExtension", wireType)
...
func (m *ResponseVoteExtension) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseVoteExtension: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseVoteExtension: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Extension == nil {
				m.Extension = &types1.VoteExtension{}
			}
			if err := m.Extension.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
