...
// IsOK returns true if Code is OK.
func (r ResponseRecheckTx) IsOK() bool {
	return r.Code == CodeTypeOK
}

// IsErr returns true if Code is something other than OK.
func (r ResponseRecheckTx) IsErr() bool {
	return r.Code != CodeTypeOK
}
...
func (r *ResponseRecheckTx) MarshalJSON() ([]byte, error) {
	s, err := jsonpbMarshaller.MarshalToString(r)
	return []byte(s), err
}

func (r *ResponseRecheckTx) UnmarshalJSON(b []byte) error {
	reader := bytes.NewBuffer(b)
	return jsonpbUnmarshaller.Unmarshal(reader, r)
}
...
var _ jsonRoundTripper = (*ResponseRecheckTx)(nil)
