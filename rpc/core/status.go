...
func (env *Environment) Status(ctx *rpctypes.Context) (*ctypes.ResultStatus, error) {
	...
	result := &ctypes.ResultStatus{
		...
		SyncInfo: ctypes.SyncInfo{
			...
			TotalSnapshots:      env.StateSyncMetricer.GetTotalSnapshots(),
			ChunkProcess:        env.StateSyncMetricer.GetChunkProcess(),
			SnapshotHeight:      env.StateSyncMetricer.GetSnapshotHeight(),
			SnapshotChunk:       env.StateSyncMetricer.GetSnapshotChunk(),
			SnapshotChunkTotal:  env.StateSyncMetricer.GetSnapshotChunkTotal(),
			BackFill:            env.StateSyncMetricer.GetBackFill(),
			BackFillTotal:       env.StateSyncMetricer.GetBackFillTotal(),
		},
