...
var Routes = map[string]*rpc.RPCFunc{
	...
	"block":                rpc.NewRPCFunc(Block, "height", rpc.Cacheable),
	"block_by_hash":        rpc.NewRPCFunc(BlockByHash, "hash", rpc.Cacheable),
	"block_results":        rpc.NewRPCFunc(BlockResults, "height", rpc.Cacheable),
	"commit":               rpc.NewRPCFunc(Commit, "height", rpc.Cacheable),
	"header":               rpc.NewRPCFunc(Header, "height", rpc.Cacheable),
	...
	"validators":           rpc.NewRPCFunc(Validators, "height,page,per_page", rpc.Cacheable),
	"dump_consensus_state": rpc.NewRPCFunc(DumpConsensusState, ""),
	"consensus_state":      rpc.NewRPCFunc(ConsensusState, ""),
	"consensus_params":     rpc.NewRPCFunc(ConsensusParams, "height", rpc.Cacheable),
