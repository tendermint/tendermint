...
func (c *Local) DialPeers(peers []string, persistent, unconditionatl, private bool) (*ctypes.ResultDialPeers, error) {
	return core.UnsafeDialPeers(c.ctx, peers, persistent, unconditionatl, private)
}
