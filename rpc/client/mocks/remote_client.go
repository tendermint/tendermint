...
// Validators provides a mock function with given fields: ctx, height, page, perPage, requestThresholdPublicKey
func (_m *RemoteClient) Validators(ctx context.Context, height *int64, page *int, perPage *int, requestThresholdPublicKey *bool) (*coretypes.ResultValidators, error) {
