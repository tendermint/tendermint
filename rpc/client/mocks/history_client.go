...
// NewHistoryClient creates a new instance of HistoryClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewHistoryClient(t testing.TB) *HistoryClient {
	mock := &HistoryClient{}
	mock.Mock.Test(t)
