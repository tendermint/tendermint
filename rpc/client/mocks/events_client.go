...
// NewEventsClient creates a new instance of EventsClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEventsClient(t testing.TB) *EventsClient {
	mock := &EventsClient{}
	mock.Mock.Test(t)
