...
* [Tendermint](https://github.com/tendermint/tendermint/blob/develop/rpc/core/routes.go)
* [tm-monitor](https://github.com/tendermint/tendermint/blob/develop/tools/tm-monitor/rpc.go)
*/
package rpc
