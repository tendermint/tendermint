...
func NewNode(config *cfg.Config,
	...
	if config.RPC.PprofListenAddress != "" {
		go func() {
			...
			logger.Error("pprof server error", "err", http.ListenAndServe(config.RPC.PprofListenAddress, nil)) //nolint:gosec,lll // we know there's no support for timeouts here.
		}()
	}
