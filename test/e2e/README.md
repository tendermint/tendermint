...
```sh
# Generate testnets randomly choosing between v0.34.21 (with a random weighting
# of 1) and v0.34.22 (with a random weighting of 2).
./build/generator -m "v0.34.21:1,v0.34.22:2" -d networks/generated/

# "HEAD" refers to the code on the current branch.
./build/generator -m "v0.34.23:1,HEAD:2" -d networks/generated/
