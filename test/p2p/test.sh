...
bash test/p2p/local_testnet_start.sh $DOCKER_IMAGE $NETWORK_NAME $N dummy
...
# start the testnet on a local network
bash test/p2p/local_testnet_start.sh $DOCKER_IMAGE $NETWORK_NAME $N persistent_dummy
