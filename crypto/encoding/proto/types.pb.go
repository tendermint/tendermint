...
type PubKey_Multisig struct {
	Multisig *github_com_tendermint_tendermint_crypto_multisig.PubKeyMultisigThreshold `protobuf:"bytes,4,opt,name=multisig,proto3,oneof,customtype=github.com/tendermint/tendermint/crypto/multisig.PubKeyMultisigThreshold" json:"multisig,omitempty"`
}
...
var fileDescriptor_32876cb9ea95204c = []byte{
	...
	0x28, 0x4a, 0x2d, 0xce, 0xc8, 0xcf, 0x49, 0x71, 0xf2, 0xb9, 0x75, 0x4f, 0xde, 0x83, 0x58, 0x47,
	...
	0x80, 0x85, 0x6c, 0x05, 0x97, 0x38, 0x8e, 0xc8, 0x13, 0xe2, 0xe1, 0x62, 0xcc, 0x06, 0x07, 0x31,
	0x4b, 0x10, 0x63, 0xb6, 0x90, 0x27, 0x17, 0x47, 0x41, 0x69, 0x52, 0x7c, 0x76, 0x6a, 0x65, 0xb1,
	0x04, 0x93, 0x02, 0xb3, 0x06, 0xb7, 0x91, 0x06, 0xb1, 0xa9, 0xcc, 0x89, 0xe5, 0xc4, 0x3d, 0x79,
	0x86, 0x20, 0xf6, 0x02, 0x30, 0xaf, 0xd8, 0x8a, 0x65, 0xc1, 0x42, 0x79, 0x46, 0xa7, 0x80, 0x13,
	0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92, 0x63, 0x7c, 0xf0, 0x48, 0x8e, 0x71, 0xc2, 0x63, 0x39, 0x86,
	0x0b, 0x8f, 0xe5, 0x18, 0x6e, 0x3c, 0x96, 0x63, 0x88, 0x22, 0x3e, 0x2b, 0xa3, 0x94, 0x52, 0x49,
	0x6c, 0x60, 0xca, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x8f, 0xa5, 0x41, 0x6a, 0xc5, 0x04, 0x00,
	0x00,
}
...
func (m *PubKey_Multisig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Multisig != nil {
		{
			size := m.Multisig.Size()
			i -= size
			if _, err := m.Multisig.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
