...
// source: proto/crypto/types.proto
...
func init() {
	proto.RegisterType((*PublicKey)(nil), "tendermint.proto.crypto.PublicKey")
	proto.RegisterType((*PrivateKey)(nil), "tendermint.proto.crypto.PrivateKey")
}
