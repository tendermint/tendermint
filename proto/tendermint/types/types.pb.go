...
type Header struct {
	...
	CoreChainLockedHeight uint32            `protobuf:"varint,4,opt,name=core_chain_locked_height,json=coreChainLockedHeight,proto3" json:"core_chain_locked_height,omitempty"`
	Time                  time.Time         `protobuf:"bytes,5,opt,name=time,proto3,stdtime" json:"time"`
	// prev block info
	LastBlockId BlockID `protobuf:"bytes,6,opt,name=last_block_id,json=lastBlockId,proto3" json:"last_block_id"`
...
// ChainLock represents a core chain lock for synchronization between state data and core chain
...
func (m *ChainLock) Reset()         { *m = ChainLock{} }
func (m *ChainLock) String() string { return proto.CompactTextString(m) }
func (*ChainLock) ProtoMessage()    {}
func (*ChainLock) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3a6e55e2345de56, []int{4}
}
func (m *ChainLock) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ChainLock) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ChainLock.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ChainLock) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ChainLock.Merge(m, src)
}
func (m *ChainLock) XXX_Size() int {
	return m.Size()
}
func (m *ChainLock) XXX_DiscardUnknown() {
	xxx_messageInfo_ChainLock.DiscardUnknown(m)
}

var xxx_messageInfo_ChainLock proto.InternalMessageInfo

func (m *ChainLock) GetCoreBlockHeight() uint32 {
	if m != nil {
...
func (m *ChainLock) GetCoreBlockHash() []byte {
	if m != nil {
...
func (m *ChainLock) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
type Proposal struct {
	Type                  SignedMsgType `protobuf:"varint,1,opt,name=type,proto3,enum=tendermint.types.SignedMsgType" json:"type,omitempty"`
	Height                int64         `protobuf:"varint,2,opt,name=height,proto3" json:"height,omitempty"`
	CoreChainLockedHeight uint32        `protobuf:"varint,3,opt,name=core_chain_locked_height,json=coreChainLockedHeight,proto3" json:"core_chain_locked_height,omitempty"`
	Round                 int32         `protobuf:"varint,4,opt,name=round,proto3" json:"round,omitempty"`
	PolRound              int32         `protobuf:"varint,5,opt,name=pol_round,json=polRound,proto3" json:"pol_round,omitempty"`
	BlockID               BlockID       `protobuf:"bytes,6,opt,name=block_id,json=blockId,proto3" json:"block_id"`
...
type BlockMeta struct {
	...
	HasChainLock bool    `protobuf:"varint,5,opt,name=has_chain_lock,json=hasChainLock,proto3" json:"has_chain_lock,omitempty"`
}
...
func (m *BlockMeta) GetHasChainLock() bool {
	if m != nil {
		return m.HasChainLock
	}
	return false
}
...
func init() {
	...
	proto.RegisterType((*ChainLock)(nil), "tendermint.types.ChainLock")
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}

func (this *ChainLock) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ChainLock)
	if !ok {
		that2, ok := that.(ChainLock)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *ChainLock) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ChainLock) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ChainLock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ChainLock) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ChainLock: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ChainLock: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *BlockMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HasChainLock", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
