...
type BlockParams struct {
	...
	// Indicates if CheckTx should be called
	// for all transactions after a block is executed
	RecheckTx bool `protobuf:"varint,3,opt,name=recheck_tx,json=recheckTx,proto3" json:"recheck_tx,omitempty"`
}
...
func (m *BlockParams) GetRecheckTx() bool {
	if m != nil {
		return m.RecheckTx
	}
	return false
...
var fileDescriptor_e12598271a686f57 = []byte{
	...
	,
}
