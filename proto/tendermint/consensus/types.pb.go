...
func (m *NewRoundStep) GetHeight() uint64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (m *ProposalPOL) GetHeight() uint64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (m *BlockPart) GetHeight() uint64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (m *HasVote) GetHeight() uint64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (m *VoteSetMaj23) GetHeight() uint64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (m *VoteSetBits) GetHeight() uint64 {
	if m != nil {
		return m.Height
	}
	return 0
...
var fileDescriptor_81a22d2efc008981 = []byte{
	...
	,
}
