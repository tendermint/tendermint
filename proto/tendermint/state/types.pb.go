...
type ABCIResponses struct {
	DeliverBlocks []*types.ResponseDeliverBlock `protobuf:"bytes,1,rep,name=deliver_blocks,json=deliverBlocks,proto3" json:"deliver_blocks,omitempty"`
}
...
func (m *ABCIResponses) GetDeliverBlocks() []*types.ResponseDeliverBlock {
	if m != nil {
		return m.DeliverBlocks
	}
	return nil
}
...
var fileDescriptor_ccfacf933f22bf93 = []byte{
	...
	,
}
...
func (m *ABCIResponses) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DeliverBlocks) > 0 {
		for iNdEx := len(m.DeliverBlocks) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DeliverBlocks[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ABCIResponses) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeliverBlocks", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DeliverBlocks = append(m.DeliverBlocks, &types.ResponseDeliverBlock{})
			if err := m.DeliverBlocks[len(m.DeliverBlocks)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
