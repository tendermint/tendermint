...
import (
	...
	types1 "github.com/tendermint/tendermint/abcix/types"
...
type ABCIResponses struct {
	...
	DeliverBlock *types1.ResponseDeliverBlock `protobuf:"bytes,4,opt,name=deliver_block,json=deliverBlock,proto3" json:"deliver_block,omitempty"`
}
...
func (m *ABCIResponses) GetDeliverBlock() *types1.ResponseDeliverBlock {
	if m != nil {
		return m.DeliverBlock
	}
	return nil
}
...
var fileDescriptor_ccfacf933f22bf93 = []byte{
	...
	,
}
...
func (m *ABCIResponses) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.DeliverBlock == nil {
				m.DeliverBlock = &types1.ResponseDeliverBlock{}
			}
			if err := m.DeliverBlock.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
