...
type State struct {
	...
	LastCoreBlockHeight uint32           `protobuf:"varint,5,opt,name=last_core_block_height,json=lastCoreBlockHeight,proto3" json:"last_core_block_height,omitempty"`
	LastBlockID         types1.BlockID   `protobuf:"bytes,6,opt,name=last_block_id,json=lastBlockId,proto3" json:"last_block_id"`
	LastBlockTime       time.Time        `protobuf:"bytes,7,opt,name=last_block_time,json=lastBlockTime,proto3,stdtime" json:"last_block_time"`
	LastChainLock       types1.ChainLock `protobuf:"bytes,8,opt,name=last_chain_lock,json=lastChainLock,proto3" json:"last_chain_lock"`
	NextChainLock       types1.ChainLock `protobuf:"bytes,9,opt,name=next_chain_lock,json=nextChainLock,proto3" json:"next_chain_lock"`
	...
	NextValidators              *types1.ValidatorSet `protobuf:"bytes,10,opt,name=next_validators,json=nextValidators,proto3" json:"next_validators,omitempty"`
	Validators                  *types1.ValidatorSet `protobuf:"bytes,11,opt,name=validators,proto3" json:"validators,omitempty"`
...
func (m *State) GetLastCoreBlockHeight() uint32 {
	if m != nil {
		return m.LastCoreBlockHeight
	}
	return 0
}
...
func (m *State) GetLastChainLock() types1.ChainLock {
	if m != nil {
		return m.LastChainLock
	}
	return types1.ChainLock{}
}

func (m *State) GetNextChainLock() types1.ChainLock {
	if m != nil {
		return m.NextChainLock
	}
	return types1.ChainLock{}
}
...
var fileDescriptor_ccfacf933f22bf93 = []byte{
	...
	,
}
...
func (m *State) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size, err := m.NextChainLock.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0x4a
	{
		size, err := m.LastChainLock.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	i--
	dAtA[i] = 0x32
	if m.LastCoreBlockHeight != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.LastCoreBlockHeight))
		i--
		dAtA[i] = 0x28
	}
...
func (m *State) Size() (n int) {
	...
	if m.LastCoreBlockHeight != 0 {
		n += 1 + sovTypes(uint64(m.LastCoreBlockHeight))
	}
	l = m.LastBlockID.Size()
	n += 1 + l + sovTypes(uint64(l))
	l = github_com_gogo_protobuf_types.SizeOfStdTime(m.LastBlockTime)
	n += 1 + l + sovTypes(uint64(l))
	l = m.LastChainLock.Size()
	n += 1 + l + sovTypes(uint64(l))
	l = m.NextChainLock.Size()
	n += 1 + l + sovTypes(uint64(l))
	if m.NextValidators != nil {
...
func (m *State) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastCoreBlockHeight", wireType)
			}
			m.LastCoreBlockHeight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastCoreBlockHeight |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastChainLock", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.LastChainLock.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NextChainLock", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.NextChainLock.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 10:
