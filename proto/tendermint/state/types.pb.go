...
type State struct {
	...
	LastCoreChainLock types1.CoreChainLock `protobuf:"bytes,100,opt,name=last_core_chain_lock,json=lastCoreChainLock,proto3" json:"last_core_chain_lock"`
	NextCoreChainLock types1.CoreChainLock `protobuf:"bytes,101,opt,name=next_core_chain_lock,json=nextCoreChainLock,proto3" json:"next_core_chain_lock"`
...
func (m *State) GetLastCoreChainLock() types1.CoreChainLock {
	if m != nil {
		return m.LastCoreChainLock
	}
	return types1.CoreChainLock{}
}
...
var fileDescriptor_ccfacf933f22bf93 = []byte{
	...
	,
}
...
func (m *State) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0xaa
	{
		size, err := m.LastCoreChainLock.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *State) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 100:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastCoreChainLock", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.LastCoreChainLock.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 101:
