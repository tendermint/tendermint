...
type State struct {
	...
	LastChainLock   types1.ChainLock `protobuf:"bytes,7,opt,name=last_chain_lock,json=lastChainLock,proto3" json:"last_chain_lock"`
	NextChainLock   types1.ChainLock `protobuf:"bytes,8,opt,name=next_chain_lock,json=nextChainLock,proto3" json:"next_chain_lock"`
	...
	NextValidators              *types1.ValidatorSet `protobuf:"bytes,9,opt,name=next_validators,json=nextValidators,proto3" json:"next_validators,omitempty"`
	Validators                  *types1.ValidatorSet `protobuf:"bytes,10,opt,name=validators,proto3" json:"validators,omitempty"`
...
var fileDescriptor_ccfacf933f22bf93 = []byte{
	...
	,
}
