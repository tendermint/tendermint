...
func (m *ABCIResult) Reset()         { *m = ABCIResult{} }
func (m *ABCIResult) String() string { return proto.CompactTextString(m) }
func (*ABCIResult) ProtoMessage()    {}
func (*ABCIResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff06f8095857fb18, []int{11}
}
func (m *ABCIResult) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ABCIResult) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ABCIResult.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ABCIResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ABCIResult.Merge(m, src)
}
func (m *ABCIResult) XXX_Size() int {
	return m.Size()
}
func (m *ABCIResult) XXX_DiscardUnknown() {
	xxx_messageInfo_ABCIResult.DiscardUnknown(m)
}

var xxx_messageInfo_ABCIResult proto.InternalMessageInfo

func (m *ABCIResult) GetCode() uint32 {
	if m != nil {
		return m.Code
	}
	return 0
...
func (m *ABCIResult) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
type ABCIResults struct {
	AbciResult []*ABCIResult `protobuf:"bytes,1,rep,name=abci_result,json=abciResult,proto3" json:"abci_result,omitempty"`
}

func (m *ABCIResults) Reset()         { *m = ABCIResults{} }
func (m *ABCIResults) String() string { return proto.CompactTextString(m) }
func (*ABCIResults) ProtoMessage()    {}
func (*ABCIResults) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff06f8095857fb18, []int{12}
}
func (m *ABCIResults) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ABCIResults) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ABCIResults.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ABCIResults) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ABCIResults.Merge(m, src)
}
func (m *ABCIResults) XXX_Size() int {
	return m.Size()
}
func (m *ABCIResults) XXX_DiscardUnknown() {
	xxx_messageInfo_ABCIResults.DiscardUnknown(m)
}

var xxx_messageInfo_ABCIResults proto.InternalMessageInfo

func (m *ABCIResults) GetAbciResult() []*ABCIResult {
	if m != nil {
		return m.AbciResult
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ABCIResult)(nil), "tendermint.proto.types.ABCIResult")
	proto.RegisterType((*ABCIResults)(nil), "tendermint.proto.types.ABCIResults")
...
var fileDescriptor_ff06f8095857fb18 = []byte{
	...
	,
}
...
func (m *ABCIResult) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ABCIResult) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ABCIResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ABCIResults) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ABCIResults) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ABCIResults) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.AbciResult) > 0 {
		for iNdEx := len(m.AbciResult) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.AbciResult[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ABCIResult) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ABCIResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ABCIResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ABCIResults) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ABCIResults: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ABCIResults: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AbciResult", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AbciResult = append(m.AbciResult, &ABCIResult{})
			if err := m.AbciResult[len(m.AbciResult)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
