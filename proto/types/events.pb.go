...
var fileDescriptor_1bb9bdae76a076d6 = []byte{
	...
	0xb5, 0x40, 0x82, 0x59, 0x81, 0x51, 0x83, 0x33, 0x08, 0xcc, 0x76, 0x4a, 0xba, 0xf0, 0x50, 0x8e,
	...
	0x8f, 0x70, 0x31, 0x32, 0x13, 0xc9, 0x87, 0x49, 0x6c, 0x60, 0x8e, 0x31, 0x20, 0x00, 0x00, 0xff,
	0xff, 0xdf, 0x9d, 0x31, 0x33, 0xf7, 0x00, 0x00, 0x00,
}

func (this *EventDataRoundState) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*EventDataRoundState)
	if !ok {
		that2, ok := that.(EventDataRoundState)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *EventDataRoundState) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&types.EventDataRoundState{")
...
func (this *EventDataRoundState) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&EventDataRoundState{`,
