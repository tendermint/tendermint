...
func (c *MConnection) Send(chID byte, msgBytes []byte) bool {
	...
	c.Logger.Debug("Send", "channel", chID, "conn", c, "msgBytes", log.LazySprintf("%X", msgBytes))
	...
	if success {
		...
		c.Logger.Debug("Send failed", "channel", chID, "conn", c, "msgBytes", log.LazySprintf("%X", msgBytes))
	}
	return success
}
...
func (c *MConnection) TrySend(chID byte, msgBytes []byte) bool {
	...
	c.Logger.Debug("TrySend", "channel", chID, "conn", c, "msgBytes", log.LazySprintf("%X", msgBytes))
