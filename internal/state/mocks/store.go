...
func (_m *Store) LoadABCIResponses(_a0 int64) (*types.ResponseFinalizeBlock, error) {
	ret := _m.Called(_a0)

	var r0 *types.ResponseFinalizeBlock
	if rf, ok := ret.Get(0).(func(int64) *types.ResponseFinalizeBlock); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Store) LoadConsensusParams(_a0 int64) (tenderminttypes.ConsensusParams, error) {
	ret := _m.Called(_a0)

	var r0 tenderminttypes.ConsensusParams
	if rf, ok := ret.Get(0).(func(int64) tenderminttypes.ConsensusParams); ok {
		r0 = rf(_a0)
	} else {
...
func (_m *Store) SaveABCIResponses(_a0 int64, _a1 *types.ResponseFinalizeBlock) error {
	ret := _m.Called(_a0, _a1)

	var r0 error
	if rf, ok := ret.Get(0).(func(int64, *types.ResponseFinalizeBlock) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Store) SaveValidatorSets(_a0 int64, _a1 int64, _a2 *tenderminttypes.ValidatorSet) error {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 error
	if rf, ok := ret.Get(0).(func(int64, int64, *tenderminttypes.ValidatorSet) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
