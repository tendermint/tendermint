...
func (EmptyEvidencePool) PendingEvidence(maxBytes int64) (ev []types.Evidence, size int64) { return nil, 0 }
...
func (EmptyEvidencePool) CheckEvidence(ctx context.Context, evList types.EvidenceList) error { return nil}
