...
type ReactorV2 struct {
	...
	availablePeers map[p2ptypes.NodeID]struct{}
	...
	requestsSent map[p2ptypes.NodeID]struct{}
	...
	lastReceivedRequests map[p2ptypes.NodeID]time.Time
...
func NewReactorV2(
	...
	r := &ReactorV2{
		...
		availablePeers:       make(map[p2ptypes.NodeID]struct{}),
		requestsSent:         make(map[p2ptypes.NodeID]struct{}),
		lastReceivedRequests: make(map[p2ptypes.NodeID]time.Time),
	}
...
func (r *ReactorV2) markPeerRequest(peer p2ptypes.NodeID) error {
	r.mtx.Lock()
	defer r.mtx.Unlock()
...
func (r *ReactorV2) markPeerResponse(peer p2ptypes.NodeID) error {
	r.mtx.Lock()
	defer r.mtx.Unlock()
...
func (r *ReactorV2) isLegacyPeer(peer p2ptypes.NodeID) bool {
