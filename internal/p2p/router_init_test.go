...
func TestRouter_ConstructQueueFactory(t *testing.T) {
	...
	t.Run("Default", func(t *testing.T) {
		...
		opts := RouterOptions{}
		r, err := NewRouter(log.NewNopLogger(), nil, nil, nil, func() *types.NodeInfo { return &types.NodeInfo{} }, nil, Endpoint{}, opts)
	...
	t.Run("NonExistant", func(t *testing.T) {
		...
		_, err := NewRouter(log.NewNopLogger(), nil, nil, nil, func() *types.NodeInfo { return &types.NodeInfo{} }, nil, Endpoint{}, opts)
		require.Error(t, err)
