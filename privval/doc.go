...
KMSListener establishes a connection to an external process, like a Key Management Server (KMS), using a socket.
KMSListener listens for the external KMS process to dial in.
KMSListener takes a listener, which determines the type of connection
