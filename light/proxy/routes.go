...
func RPCRoutes(c *lrpc.Client) map[string]*rpcserver.RPCFunc {
	return map[string]*rpcserver.RPCFunc{
		...
		// info API
		"health":               rpcserver.NewRPCFunc(makeHealthFunc(c), "", rpcserver.FuncOptions{}),
		"status":               rpcserver.NewRPCFunc(makeStatusFunc(c), "", rpcserver.FuncOptions{}),
		"net_info":             rpcserver.NewRPCFunc(makeNetInfoFunc(c), "", rpcserver.FuncOptions{}),
		"blockchain":           rpcserver.NewRPCFunc(makeBlockchainInfoFunc(c), "minHeight,maxHeight", rpcserver.CacheFuncOpts),
		"genesis":              rpcserver.NewRPCFunc(makeGenesisFunc(c), "", rpcserver.CacheFuncOpts),
		"genesis_chunked":      rpcserver.NewRPCFunc(makeGenesisChunkedFunc(c), "", rpcserver.CacheFuncOpts),
		"block":                rpcserver.NewRPCFunc(makeBlockFunc(c), "height", rpcserver.CacheFuncOpts),
		"header":               rpcserver.NewRPCFunc(makeHeaderFunc(c), "height", rpcserver.CacheFuncOpts),
		"header_by_hash":       rpcserver.NewRPCFunc(makeHeaderByHashFunc(c), "hash", rpcserver.CacheFuncOpts),
		"block_by_hash":        rpcserver.NewRPCFunc(makeBlockByHashFunc(c), "hash", rpcserver.CacheFuncOpts),
		"block_results":        rpcserver.NewRPCFunc(makeBlockResultsFunc(c), "height", rpcserver.CacheFuncOpts),
		"commit":               rpcserver.NewRPCFunc(makeCommitFunc(c), "height", rpcserver.CacheFuncOpts),
		"tx":                   rpcserver.NewRPCFunc(makeTxFunc(c), "hash,prove", rpcserver.CacheFuncOpts),
		"tx_search":            rpcserver.NewRPCFunc(makeTxSearchFunc(c), "query,prove,page,per_page,order_by", rpcserver.FuncOptions{}),
		"block_search":         rpcserver.NewRPCFunc(makeBlockSearchFunc(c), "query,page,per_page,order_by", rpcserver.FuncOptions{}),
		"validators":           rpcserver.NewRPCFunc(makeValidatorsFunc(c), "height,page,per_page", rpcserver.CacheFuncOpts),
		"dump_consensus_state": rpcserver.NewRPCFunc(makeDumpConsensusStateFunc(c), "", rpcserver.FuncOptions{}),
		"consensus_state":      rpcserver.NewRPCFunc(makeConsensusStateFunc(c), "", rpcserver.FuncOptions{}),
		"consensus_params":     rpcserver.NewRPCFunc(makeConsensusParamsFunc(c), "height", rpcserver.CacheFuncOpts),
		"unconfirmed_txs":      rpcserver.NewRPCFunc(makeUnconfirmedTxsFunc(c), "limit", rpcserver.FuncOptions{}),
		"num_unconfirmed_txs":  rpcserver.NewRPCFunc(makeNumUnconfirmedTxsFunc(c), "", rpcserver.FuncOptions{}),

		// tx broadcast API
		"broadcast_tx_commit": rpcserver.NewRPCFunc(makeBroadcastTxCommitFunc(c), "tx", rpcserver.FuncOptions{}),
		"broadcast_tx_sync":   rpcserver.NewRPCFunc(makeBroadcastTxSyncFunc(c), "tx", rpcserver.FuncOptions{}),
		"broadcast_tx_async":  rpcserver.NewRPCFunc(makeBroadcastTxAsyncFunc(c), "tx", rpcserver.FuncOptions{}),

		// abci API
		"abci_query": rpcserver.NewRPCFunc(makeABCIQueryFunc(c), "path,data,height,prove", rpcserver.FuncOptions{}),
		"abci_info":  rpcserver.NewRPCFunc(makeABCIInfoFunc(c), "", rpcserver.CacheFuncOpts),

		// evidence API
		"broadcast_evidence": rpcserver.NewRPCFunc(makeBroadcastEvidenceFunc(c), "evidence", rpcserver.FuncOptions{}),
	}
}
