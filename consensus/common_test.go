...
func signVote(vs *validatorStub, voteType prototypes.SignedMsgType, hash []byte, header types.PartSetHeader) *types.Vote {
...
func ensurePrecommit(voteCh <-chan tmpubsub.Message, height int64, round int32) {
	ensureVote(voteCh, height, round, prototypes.PrecommitType)
}

func ensurePrevote(voteCh <-chan tmpubsub.Message, height int64, round int32) {
	ensureVote(voteCh, height, round, prototypes.PrevoteType)
}
