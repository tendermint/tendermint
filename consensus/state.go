...
func (cs *State) enterNewRound(height int64, round int32) {
	...
	if cs.Height != height || round < cs.Round || (cs.Round == round && cs.Step != cstypes.RoundStepNewHeight) {
		logger.Debug(
			...
			"current", log.LazySprintf("%v/%v/%v", cs.Height, cs.Round, cs.Step),
		)
		return
	}
	...
	logger.Debug("entering new round", "current", log.LazySprintf("%v/%v/%v", cs.Height, cs.Round, cs.Step))
...
func (cs *State) enterPropose(height int64, round int32) {
	...
	logger.Debug("entering propose step", "current", log.LazySprintf("%v/%v/%v", cs.Height, cs.Round, cs.Step))
...
func (cs *State) enterPrevote(height int64, round int32) {
	...
	logger.Debug("entering prevote step", "current", log.LazySprintf("%v/%v/%v", cs.Height, cs.Round, cs.Step))
...
func (cs *State) enterPrevoteWait(height int64, round int32) {
	...
	logger.Debug("entering prevote wait step", "current", log.LazySprintf("%v/%v/%v", cs.Height, cs.Round, cs.Step))
...
func (cs *State) enterPrecommit(height int64, round int32) {
	...
	logger.Debug("entering precommit step", "current", log.LazySprintf("%v/%v/%v", cs.Height, cs.Round, cs.Step))
...
func (cs *State) enterPrecommitWait(height int64, round int32) {
	...
	if cs.Height != height || round < cs.Round || (cs.Round == round && cs.TriggeredTimeoutPrecommit) {
		logger.Debug(
			...
			"current", log.LazySprintf("%v/%v", cs.Height, cs.Round),
		)
		return
	}
	...
	logger.Debug("entering precommit wait step", "current", log.LazySprintf("%v/%v/%v", cs.Height, cs.Round, cs.Step))
...
func (cs *State) enterCommit(height int64, commitRound int32) {
	...
	logger.Debug("entering commit step", "current", log.LazySprintf("%v/%v/%v", cs.Height, cs.Round, cs.Step))
...
func (cs *State) tryFinalizeCommit(height int64) {
	...
	if !cs.ProposalBlock.HashesTo(blockID.Hash) {
		...
		logger.Debug(
			...
			"proposal_block", log.LazyBlockHash(cs.ProposalBlock),
...
func (cs *State) finalizeCommit(height int64) {
	...
	logger.Info(
		...
		"hash", log.LazyBlockHash(block),
		"root", block.AppHash,
		"num_txs", len(block.Txs),
	)
	logger.Debug("committed block", "block", log.LazySprintf("%v", block))
	...
	if hasTwoThirds && !blockID.IsZero() && (cs.ValidRound < cs.Round) {
		if cs.ProposalBlock.HashesTo(blockID.Hash) {
			cs.Logger.Debug(
				...
				"valid_block_hash", log.LazyBlockHash(cs.ProposalBlock),
			)
